...
function Portfolio() {
  ...
  return (
    <div id='portfolio-page' onClick={handleCloseMenu} className='rest-of-page'>
      ...
      <p id='portfolio-text' className='rest-of-page'><a href='mailto:danarsevcik@gmail.com'>contact</a> me with any questions!</p>
              ...
              <Slider id='portfolio-slider' className='rest-of-page'>
                <Slide index={0} className='photo rest-of-page'>
                  ...
                  <div className='links rest-of-page'>
                    <a href='https://github.com/danasevcik/textconnect-frontend' target='_blank' rel='noopener noreferrer' className='github rest-of-page'>Github Frontend</a><br/>
                    <a href='https://github.com/danasevcik/textconnect-backend' target='_blank' rel='noopener noreferrer' className='github rest-of-page'>Github Backend</a><br/>
                  </div>
                  <img className='rest-of-page youtube-vid' src='text-connect.gif' alt='text connect giphy' id='portfolio-gif' target='_blank' rel='noopener noreferrer' onClick={() => openNewWindow('https://www.youtube.com/watch?v=GezKCrnQ5iE')}/>
                </Slide>
                <Slide index={1} className='photo rest-of-page'>
                  ...
                  <div className='links rest-of-page'>
                    <a href='https://github.com/danasevcik/normor/tree/master/frontend' target='_blank' rel='noopener noreferrer' className='github rest-of-page'>Github Frontend</a><br/>
                    <a href='https://github.com/danasevcik/normor/tree/master/backend' target='_blank' rel='noopener noreferrer' className='github rest-of-page'>Github Backend</a><br/>
                  </div>
                  <img className='rest-of-page youtube-vid' src='normor.gif' alt='normor giphy' id='portfolio-gif' target='_blank' rel='noopener noreferrer' onClick={() => openNewWindow('https://www.youtube.com/watch?v=rTbQzWDsOKw')}/>
                </Slide>
                <Slide index={2} className='photo rest-of-page'>
                  ...
                  <div className='links rest-of-page'>
                    <a href='https://github.com/danasevcik/trash-tag-frontend' target='_blank' rel='noopener noreferrer' className='github rest-of-page'>Github Frontend</a><br/>
                    <a href='https://github.com/danasevcik/trash-tag-backend' target='_blank' rel='noopener noreferrer' className='github rest-of-page'>Github Backend</a><br/>
                  </div>
                  <img className='rest-of-page youtube-vid' src='trashtag.gif' alt='trash tag giphy' id='portfolio-gif' target='_blank' rel='noopener noreferrer' onClick={() => openNewWindow('https://www.youtube.com/watch?v=PD-wkOjpGTQ')}/>
                </Slide>
              </Slider>
